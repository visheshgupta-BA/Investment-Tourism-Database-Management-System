...
#Q3.) Write a SQL query using EXISTS to retrieve the details of only those customers who have given an ‘excellent’ rating along with customer name and customer country 
...
#Q4) Write a SQL Query to display all the details of common countries having prime minister and president for particular continent along with their independent year
...
# Q5) Retrieve 15 feedback Ids and the corresponding rating given by different customers for the services offered to them along with their first and last name.
...
# Q6) Find the country and continent whose independence year is between 1910 and 1970, and also whose economic behavior is characterized by an inflation rate and gdp percapita that are greater than their own averages for the year 2010.
...
# Q7) Using Common Table Expression, compose a SQL query to display 9 records of language name, country code, percentage of languages spoken, and government form of these country code.
...
# Q8) Write a SQL query using ANY to extract the list of countries, income group, and GDP for only those countries with life expectancy greater than 83
...
# Q9) Display City name, country code, Prime Minister name, Country name, City Population, city Urban Population, Surface Area of country, country constitution name, and its currency name and its fractional unit which has a metro population not equals to zero and display 12 records for only India, United Kingdom, oman, Australia, Pakistan countries and sort the metro population column in ascending order.
...
# Q10) Retrieve several details for the Year 2010 population that indicate whether the official language of a particular country(code) is True or False, as well as the percentage of each language spoken in the country and the life expectancy for 2010 with the country code.
...
# Q11) Find the Investment Prediction of all the countries for making investment by investor based on the year of 2015 and generate those countries name and their sub attributes which has greater than or equal to maximum gdp_percapita.
...
# Q12) Determine the top most Countries whose total investment is greater than the average of itself for Low income group category specially for the singular year of 2015
